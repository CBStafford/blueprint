                ...
                Forms\Components\Group::make()
                    ->schema([
                        ...
                        ->schema([
                            ...
                            Forms\Components\TextInput::make(name:'email')->required()->unique(ignoreRecord:true),
                            // Forms\Components\PASSWORD_BCRYPT::make(name:'password'),
                        ]),
                        Forms\Components\Section::make('Permissions')
                        ->schema([
                            Forms\Components\Checkbox::make(name:'is_active') ,                           
                            Forms\Components\Checkbox::make(name:'is_admin'),
    ...
    public static function table(Table $table): Table
    {
        return $table
            ->columns([
                ...
                Tables\Columns\IconColumn::make(name:'is_admin')->boolean(),
